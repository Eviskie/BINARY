...
// Format output String
		...
		// Output message
Scanner.showMessageDialog(null,binaryOutput + "\n" + decimalOutput,
...
// Output message
Scanner.showMessageDialog(null, binaryOutput4 + "\n" + decimalOutput4,
		"Binary to Decimal Conversion", JOptionPane.INFORMATION_MESSAGE);
// #############################################################################################
...
// Output message
Scanner.showMessageDialog(null, binaryOutput3 + "\n" + decimalOutput3,
		"Binary to Decimal Conversion", JOptionPane.INFORMATION_MESSAGE);
// #############################################################################################
...
// Output message
Scanner.showMessageDialog(null, binaryOutput2 + "\n" + decimalOutput2,
		"Binary to Decimal Conversion", JOptionPane.INFORMATION_MESSAGE);
// #############################################################################################
		...
		// Output message
		Scanner.showMessageDialog(null, binaryOutput1 + "\n" + decimalOutput1,
				"Binary to Decimal Conversion", JOptionPane.INFORMATION_MESSAGE);
		// #############################################################################################
